...
class InsightGeneration:
    ...
    def KMeansClustering(self, df):
        ...
        a sentence contains for than 15 words.Minimum 2000 words."""
        ...
        for feature1 in range(len(columns) - 2):
            for feature2 in range(feature1 + 1, len(columns) - 2):
                ...
                ax.set_title(
                    f"KMeans Clustering: {columns[feature1]} vs {columns[feature2]}")
                plot_idx += 1
        ...
        return response.generations[0].text, plot_data
    ...
    def logisticRegression(self, df, label):
        ...
        Must not bold the Headings but use\
        points and give a newline\
        after every 15 words in a line.Minimum 2000 words."""
    ...
    def randomForestClassifier(self, df, label):
        ...
        and give a newline after every 15 words in a line.Minimum 2000 words."""
